 ...
 * validate-skills.js
 *
 * Validates every skill in .agents/skills/ against the local skill rules.
 *
...
const REQUIRED_SECTIONS = [
  ...
  ['## Common Rationalizations', '## Các biện hộ thường gặp (Common Rationalizations)'],
  ['## Red Flags', '## Dấu hiệu cảnh báo (Red Flags)'],
...
const SECTION_EXEMPT_SKILLS = {
  ...
  'idea-refine':        'Uses a divergent/convergent workflow structure instead of the standard section template.',
};
